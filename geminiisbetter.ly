...
PartPOneVoiceOne = \relative es' {
  ...
  % Measure 1
  \U <es g>8 [ _\pp \U c8 \U <es g>8 _. ] b'8\rest \U <f as>8 [ \U c8 ] \U <f as>8 _. b16\rest \U <d, f bes>16 | 
  
  % Measure 2
  \U <d f bes>4 b'8\rest \U as16 [ \U bes16 ] \U as4 \U g4 | 
  
  % Measure 3
  \U <es g>4 \U <d f as>4 \U <d f bes>4 \U <es g>8 b'16\rest \U g16 _> \break | 
  
  % Measure 4
  \U as16 _. [ _\< \U g16 \U dis8 _. ] \U g8 _. [ \U c8 _. ] \U gis4 \! \U f8 [ _\mp \U <as, as'>8 ]
}
...
PartPOneVoiceFive = \relative c {
  ...
  % Measure 1
  \D <c es g c>8 ^- d8\rest c4\rest \U <f, as c f>8 _- d'8\rest d8\rest c16\rest c16\rest | 
  
  % Measure 2
  \D <bes d f bes>4 d4\rest \D <es as c>4 d4\rest | 
  
  % Measure 3
  \U <g, c es g>4 \U <f as c f>4 \U <f bes d f>4 \U <g c es g>8 d'8\rest \break | 
  
  % Measure 4
  \U <es, g c>4 e'4\rest \U f,8 [ \U as8 \U <as c f>8 _- ] d8\rest
}
  ...
  <<
    \new PianoStaff <<
      ...
      \context Staff = "2" <<
        ...
        % Removed empty/undefined voices (Six & Seven) to prevent compilation errors
      >>
    >>
  >>
  \layout {}
